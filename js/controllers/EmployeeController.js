 ...
 $scope.pageChanged = function(pageNo) {
	...
	var EmployeeCountFailure = function(errorData){
        ...
        $scope.addEmployee = function() {
            var modalInstance = $modal.open({
                templateUrl:  constantValues.HTML_LOC + 'angularviews/EmployeeForm.html',
                controller: 'addEmployeeCtrl',
                keyboard: false
                //resolve: {
                //    EmployeeData: ["EmployeeService", "commonService",function(EmployeeService, commonService) {
                //        commonService.toggleProcessing(true);
        ...
        //view  Employee popup
                $scope.editEmployee = function(Employee) {
                    var modalInstance = $modal.open({
                        templateUrl:  constantValues.HTML_LOC + 'angularviews/EmployeeView.html',
 ...
 **********************************************************************************/
    ...
    '$modalInstance', '$route', function($scope, $rootScope, $translate, $location, $modal,
            EmployeeService, commonService, constantValues, $routeParams, $window, $timeout, $modalInstance, $route) {//END_ADD_WITH_OR_WITHOUT_MODEL
	...
	$scope.calcleAdd = function(){
            $modalInstance.dismiss('cancel');//end cancle add
	};

        $scope.popup = true;//end is popup
        ...
        var saveEmployeeSuccess = function(respData) {
            ...
            if (respData.data.status && respData.data.status === true) {
                ...
                localStorage.setItem('messsage', $translate('SAVE_SUCCESS'));
            } else {
...
myApp.controller('deleteEmployeeCtrl',
        ['$scope', '$modalInstance', 'Employee', '$translate', 'EmployeeService', 'commonService', '$route',
            function($scope, $modalInstance, Employee, $translate, EmployeeService, commonService, $route) {
                ...
                $scope.errorMessage = $translate('DELETE') + ' ' + $translate('Employee') + ' ' + Employee.name;
                ...
                $scope.ok = function() {
                    ...
                    $modalInstance.dismiss('cancel');
                    localStorage.setItem('messsage', $translate('DELETE_SUCCESS'));
                    $route.reload();
                };
            }]);
 ...
 **********************************************************************************/
    ...
    'EmployeeService', 'commonService', 'constantValues', '$routeParams', '$window', '$timeout',
    '$modalInstance', '$route', 'Employee', function($scope, $rootScope, $translate, $location, $modal,
            EmployeeService, commonService, constantValues, $routeParams, $window, $timeout, $modalInstance, $route, Employee) {//END_EDIT_WITH_OR_WITHOUT_MODEL
        ...
        var updateEmployeeSuccess = function(respData) {
            ...
            commonService.toggleProcessing(false);
            if (respData.data.status && respData.data.status === true) {
                localStorage.setItem('messsage', $translate('UPDATE_SUCCESS'));
                $route.reload();
            } else {
 ...
 **********************************************************************************/
    ...
    'EmployeeService', 'commonService', 'constantValues', '$routeParams', '$window', '$timeout',
    '$modalInstance', '$route', 'Employee', function($scope, $rootScope, $translate, $location, $modal,
            EmployeeService, commonService, constantValues, $routeParams, $window, $timeout, $modalInstance, $route, Employee) {//END_VIEW_WITH_OR_WITHOUT_MODEL
