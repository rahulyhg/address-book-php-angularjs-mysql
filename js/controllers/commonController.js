...
myApp.controller('commonCtrl',
        ['$scope', '$rootScope', '$translate', '$modal', '$route',
            ...
            function ($scope, $rootScope, $translate, $modal, $route, $location, constantValues, $timeout,
                ...
                //About employeedirectory
                $scope.aboutemployeedirectory = function () {

                    var modalInstance = $modal.open({
                        templateUrl: constantValues.HTML_LOC + 'angularviews/aboutemployeedirectoryModal.html',
                        controller: 'aboutemployeedirectoryController',
                        backdrop: 'static',
                        keyboard: false
                    });
                };
...
/**********************************************************************************
 About employeedirectory Controller
 **********************************************************************************/

myApp.controller('aboutemployeedirectoryController',
